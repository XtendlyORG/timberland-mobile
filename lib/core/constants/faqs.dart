...
const faqs = [
  ...
  FAQ(
    ...
    subCategory: [
      ...
      FAQ(
        question: "GRADE 3 (MORE DIFFICULT)",
        icon: FaqIconWrapper(
          icon: Icon(
            Icons.square,
