...
class UserModel extends User {
  ...
  factory UserModel.fromMap(Map<String, dynamic> map) {
    ...
    return UserModel(
      ...
      prettierID: map['long_id'] != null ? map['long_id'] as String : "",
      ...
      profilePicUrl: map['profile_pic'] != null ? map['profile_pic'] as String : '',
      gender: map['gender'] != null ? map['gender'] as String : "",
      birthday: map['birth_date'] != null ? DateTime.tryParse(map['birth_date'] as String? ?? '') : DateTime.now(),
      ...
      mobileNumber: map['mobile_number'] != null ? map['mobile_number'] as String : "",
      ...
      accessCode: map['access_code'] != null ? map['access_code'] as String : "",
